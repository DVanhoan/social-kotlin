...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <form class="tf-section-2 form-add-post" method="POST" enctype="multipart/form-data"
            ...
            <div class="wg-box">
                ...
                <fieldset class="name">
                    ...
                    <textarea class="mb-10 ht-150" name="content" placeholder="Write your post content..." tabindex="0"
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        <input type="datetime-local" name="posting_time"
                            value="{{ old('posting_time', now()->format('Y-m-d\TH:i')) }}">
                        @error("posting_time") <span class="alert alert-danger text-center">{{$message}}</span>
                        @enderror
                    </fieldset>
                </div>
